...
<body data-theme="default" id="get-theme">
    <div class="page login-page">
        ...
        <p class="form-control__label">
                            ...
                            <div class="flex_container form-control">
    <div class="flex_item">
        <p class="form-control__label">Age</p>
        <select class="form-control__input <?php if (isset($ageerr)) echo 'form-control__input--error'; ?>" name="age">
            <option value="">Select your age</option>
            <?php for ($i = 18; $i <= 100; $i++) { ?>
                <option value="<?php echo $i; ?>" <?php if (isset($_POST['age']) && $_POST['age'] == $i) echo 'selected'; ?>><?php echo $i; ?></option>
            <?php } ?>
        </select>
        <?php if (isset($ageerr)) { ?>
