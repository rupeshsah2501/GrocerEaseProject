...
if (isset($_POST['userProfileUpdate'])) {
    ...
    if ($errCount == 0) {
        ...
        // echo("<script>location.href = 'http://localhost/GrocerEase/account-settings.php'</script>");
...
<button id="resetPasswordButton"  class="btn primary-btn form-btn" >Change Password</button>
<div id="resetPasswordSection" class="account-settings__reset hidden">
    <div class="section__header">
        <div class="section__header__heading-1">
           You can change your password from here 
        </div>
    </div>
    <div class="reset__user-details">
    <?php include './components/pages/AccountSettings/resetPassword.php'; ?>
</div>
</div>
