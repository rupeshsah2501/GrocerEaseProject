...
if (isset($_GET['email']) && isset($_GET['name'])) {
  ...
  try {
    ...
    $mail->Body = "
   <h1 style='font: bold 100% sans-serif; padding:10px; width:50%; text-align: center; text-transform: uppercase;background-color:#7FA8D4;color:white; font-size: 18px;'>Trader Registration Successfull</h1>
