...
?>
        ...
        <form action="https://www.sandbox.paypal.com/cgi-bin/webscr" id="paypal-submit" method="post" class="paypal">
            ...
            <input type="hidden" name="business" value="grocerease@business.example.com">
            <!-- Buy Now button. -->
            ...
            <!-- URLs -->
            <input type='hidden' name='cancel_return' value='http://localhost/GrocerEaseProject/error-page.php'>
            <input type='hidden' name='return' value='http://localhost/GrocerEaseProject/success-page.php?userId=<?php echo $user_id ?>&payment=true&orderId=<?php echo $orderplace_id ?>'>
            <!-- payment button. -->
