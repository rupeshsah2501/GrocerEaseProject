                ...
                <form method="POST" action="">
                    ...
                    <div class="form-control">
                        ...
                        <textarea rows="5" style="resize:vertical;" class="form-control__input <?php
                                                                                                ...
                                                                                                ?>" placeholder="Enter the product Description" name="description"><?php if ($description) {
                    ...
                    <div class="form-control ">
                        ...
                        <input class="form-control__input" placeholder="Allergy Information for the product" name="allergyInfo" value="<?php
                                                                                                                                        if ($allergyInfo) {
                                                                                                                                            echo $allergyInfo;
                                                                                                                                        }
                                                                                                                                        ?>" />
