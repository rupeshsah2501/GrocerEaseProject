            ...
            <div class="filter-result-container">
                ...
                <div class="filter-result-container__right">
                    ...
                    <div class="filter-page__Top-Row">
                        ...
                        <div class="filter-page__Top-Row__Res-Num">Showing <?php echo $nrows; ?> Results<?php if (isset($_GET['search'])) {
                        ...
                        <div class="filter-page__Top-Row__Sort">
                            ...
                            <div class="filter-page__Top-Row__Sort__Sort-Dropdown">
                                ...
                                <form method="POST" class="filter-page__Top-Row__Sort__Sort-Dropdown__Dropdown-Content">
                                    <button type="submit" name="sort" value="Name" class="filter-page__Top-Row__Sort__Sort-Dropdown__Dropdown-Content__Options" <?php if ($nameFlag) {
                                                                                                                                                                    echo "disabled";
                                                                                                                                                                } ?>>Name</button>
                                    <button type="submit" name="sort" value="PriceHL" class="filter-page__Top-Row__Sort__Sort-Dropdown__Dropdown-Content__Options" <?php if ($HLPriceFlag) {
                                                                                                                                                                        echo "disabled";
                                                                                                                                                                    } ?>>Price: High to Low</button>
                                    <button type="submit" name="sort" value="PriceLH" class="filter-page__Top-Row__Sort__Sort-Dropdown__Dropdown-Content__Options" <?php if ($LHPriceFlag) {
                                                                                                                                                                        echo "disabled";
