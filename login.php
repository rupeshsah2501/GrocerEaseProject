...
<body data-theme="default" id="get-theme">
    ...
    <div class="form-control__password">
        <input id="password-field" class="form-control__input form-control__input--password <?php
        ...
        <div class="pass-visibility">
            <span id="show-pass" class="pass-visibility__button">SHOW</span>
            <span id="hide-pass" class="pass-visibility__button">HIDE</span>
        </div>
    </div>
</div>
